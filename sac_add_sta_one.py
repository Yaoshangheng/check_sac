...
# 设置数据存放的基础路径
base_dir = '/run/media/yaoyuan/MyPassport/Yao_TC/convert_data/YN+TC_net/2023'
...
for dirpath, _, filenames in os.walk(base_dir):
    ...
    if os.path.isdir(dirpath):
        ...
        for filename in filenames:
            # 检查文件名中是否包含 'L5330'
            if 'L5342' in filename and (filename.endswith('.SAC') or filename.endswith('.sac')):
                # 构造文件的完整路径
                ...
                sac_commands += "ch stla 24.3007 stlo 98.2068 stel 1446 \n"  # 设置经纬度和海拔信息
                sac_commands += "wh \n"  # 将修改写入文件
                sac_commands += "q \n"  # 退出 SAC
